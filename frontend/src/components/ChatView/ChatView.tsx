  ...
  return (
    <div className={`flex flex-col relative ${isDarkMode ? 'bg-[#1a1a1a]' : 'bg-white'}`}>
      ...
      <div className="flex justify-center">
        ...
        <div
					className="hidden sm:block sm:w-[20%] 2xl:w-[15%] h-[calc(50vh)] fixed left-4 top-20 2xl:left-40"
				>
          <TableOfContents
            messages={chat.messages}
            isDarkMode={isDarkMode}
        ...
        {/* Messages (centered) */}
        <div className={`flex flex-col px-4 sm:px-0 pt-20 pb-28 sm:pt-4 sm:w-[50%] 2xl:w-[40%] space-y-4`}>
          {chat.messages
